...
namespace Epam.Task7.UsersAndAwards.Common
{
    public class DependencyResolver
    {
        ...
        public static IRepositoryDAO<User> UserDAO => userDao ?? (userDao = new UserSqlDao());

        public static IRepositoryDAO<Award> AwardDAO => awardDao ?? (awardDao = new AwardSqlDao());

        public static IRepositoryDAO<LinkTable> LinkTableDAO => linkTableDao ?? (linkTableDao = new LinkTableSqlDao());
